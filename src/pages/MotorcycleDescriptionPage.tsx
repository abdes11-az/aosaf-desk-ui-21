...
import { generateMotorcycleDescription, MotorcycleData } from "@/utils/motorcycleDescriptionGenerator";
...
const MotorcycleDescriptionPage = ({ data, onBack, onNewDescription }: MotorcycleDescriptionPageProps) => {
  ...
  const generateDescription = () => {
    return generateMotorcycleDescription(data as MotorcycleData, t);
  };
  ...
  return (
    <div className="page-content">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-foreground">🏍️ {t('motorcycle.title')}</h2>
